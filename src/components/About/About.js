...
const About = () => {
    return(
        <div className='about-container'>
            ...
            <p> Donc je me suis formé, seul, en suivant des cours sur <span className='bold'> Udemy </span> et en <span className='bold'> créant des applications web</span> qui m'ont permis d'apprendre les différents langages/framewor/librairies du web et leur utilisation à travers différents cas pratiques. </p>
            <div className='icons'>
